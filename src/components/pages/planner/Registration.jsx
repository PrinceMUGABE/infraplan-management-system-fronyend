...
import loginImage from "../../../assets/pictures/Project-Planner-To-Do-List.png";
            ...
            >
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  required
                />
                {errors.no_experience && <p className="text-red-500">{errors.no_experience[0]}</p>}
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="mt-1 block w-full border rounded-md p-2 text-gray-950"
                />
                {errors.certificate && <p className="text-red-500">{errors.certificate[0]}</p>}
              </div>
...
export default PlannerRegistrationPage;
